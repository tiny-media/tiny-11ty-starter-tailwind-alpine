...
#### [What are theme variables?](https://tailwindcss.com/docs/box-decoration-break#what-are-theme-variables)
...
Learn more about how theme variables map to different utility classes in the [theme variable namespaces](https://tailwindcss.com/docs/box-decoration-break#theme-variable-namespaces) documentation.

##### [Why `@theme` instead of `:root`?](https://tailwindcss.com/docs/box-decoration-break#why-theme-instead-of-root)
...
### [Relationship to utility classes](https://tailwindcss.com/docs/box-decoration-break#relationship-to-utility-classes)
...
#### [Relationship to variants](https://tailwindcss.com/docs/box-decoration-break#relationship-to-variants)
...
Learn more about how theme variables map to different utility classes and variants in the [theme variable namespaces](https://tailwindcss.com/docs/box-decoration-break#theme-variable-namespaces) documentation.

### [Theme variable namespaces](https://tailwindcss.com/docs/box-decoration-break#theme-variable-namespaces)
...
For a list of all of the default theme variables, see the [default theme variable reference](https://tailwindcss.com/docs/box-decoration-break#default-theme-variable-reference).

### [Default theme variables](https://tailwindcss.com/docs/box-decoration-break#default-theme-variables)
...
## [Customizing your theme](https://tailwindcss.com/docs/box-decoration-break#customizing-your-theme)
...
### [Extending the default theme](https://tailwindcss.com/docs/box-decoration-break#extending-the-default-theme)
...
### [Overriding the default theme](https://tailwindcss.com/docs/box-decoration-break#overriding-the-default-theme)
...
### [Using a custom theme](https://tailwindcss.com/docs/box-decoration-break#using-a-custom-theme)
...
### [Defining animation keyframes](https://tailwindcss.com/docs/box-decoration-break#defining-animation-keyframes)
...
### [Referencing other variables](https://tailwindcss.com/docs/box-decoration-break#referencing-other-variables)
...
### [Sharing across projects](https://tailwindcss.com/docs/box-decoration-break#sharing-across-projects)
...
## [Using your theme variables](https://tailwindcss.com/docs/box-decoration-break#using-your-theme-variables)
...
### [With custom CSS](https://tailwindcss.com/docs/box-decoration-break#with-custom-css)
...
### [With arbitrary values](https://tailwindcss.com/docs/box-decoration-break#with-arbitrary-values)
...
### [Referencing in JavaScript](https://tailwindcss.com/docs/box-decoration-break#referencing-in-javascript)
...
## [Default theme variable reference](https://tailwindcss.com/docs/box-decoration-break#default-theme-variable-reference)
