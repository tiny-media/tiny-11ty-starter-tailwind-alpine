...
const modules = [
    { name: 'alpinejs', fileName: 'alpinejs_core.js' },
    { name: '@alpinejs/mask', fileName: 'alpinejs_mask.js' },
    { name: '@alpinejs/anchor', fileName: 'alpinejs_anchor.js' },
    { name: '@alpinejs/collapse', fileName: 'alpinejs_collapse.js' },
    { name: '@alpinejs/focus', fileName: 'alpinejs_focus.js' },
    { name: '@alpinejs/intersect', fileName: 'alpinejs_intersect.js' },
    { name: '@alpinejs/morph', fileName: 'alpinejs_morph.js' },
    { name: '@alpinejs/persist', fileName: 'alpinejs_persist.js' },
    { name: '@alpinejs/sort', fileName: 'alpinejs_sort.js' },
    { name: '@alpinejs/ui', fileName: 'alpinejs_ui.js' },
];
...
const downloadAllModules = async () => {
    ...
    for (const module of modules) {
        try {
            ...
            console.error(`Failed to process ${module.name}. Error: ${error.message}`);
        }
    }
};
