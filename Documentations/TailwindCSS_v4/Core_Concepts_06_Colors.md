...
## Working with colors ([Working with colors](https://tailwindcss.com/docs/colors#working-with-colors))

### Using color utilities ([Using color utilities](https://tailwindcss.com/docs/colors#using-color-utilities))
...
### Adjusting opacity ([Adjusting opacity](https://tailwindcss.com/docs/colors#adjusting-opacity))
...
### Targeting dark mode ([Targeting dark mode](https://tailwindcss.com/docs/colors#targeting-dark-mode))
...
### Referencing in CSS ([Referencing in CSS](https://tailwindcss.com/docs/colors#referencing-in-css))
...
You can also use these as [arbitrary values](https://tailwindcss.com/docs/colors) in utility classes:
...
## Customizing your colors ([Customizing your colors](https://tailwindcss.com/docs/colors#customizing-your-colors))
...
### Overriding default colors ([Overriding default colors](https://tailwindcss.com/docs/colors#overriding-default-colors))
...
### Disabling default colors ([Disabling default colors](https://tailwindcss.com/docs/colors#disabling-default-colors))
...
### Using a custom palette ([Using a custom palette](https://tailwindcss.com/docs/colors#using-a-custom-palette))
...
### Referencing other variables ([Referencing other variables](https://tailwindcss.com/docs/colors#referencing-other-variables))
...
## Default color palette reference ([Default color palette reference](https://tailwindcss.com/docs/colors#default-color-palette-reference))
