...
### [Overview](https://tailwindcss.com/docs/box-decoration-break#overview)
...
### [Why not just use inline styles?](https://tailwindcss.com/docs/box-decoration-break#why-not-just-use-inline-styles)
...
## [Thinking in utility classes](https://tailwindcss.com/docs/box-decoration-break#thinking-in-utility-classes)

### [Styling hover and focus states](https://tailwindcss.com/docs/box-decoration-break#styling-hover-and-focus-states)
...
### [Media queries and breakpoints](https://tailwindcss.com/docs/box-decoration-break#media-queries-and-breakpoints)
...
### [Targeting dark mode](https://tailwindcss.com/docs/box-decoration-break#targeting-dark-mode)
...
### [Using class composition](https://tailwindcss.com/docs/box-decoration-break#using-class-composition)
...
### [Using arbitrary values](https://tailwindcss.com/docs/box-decoration-break#using-arbitrary-values)
...
#### [How does this even work?](https://tailwindcss.com/docs/box-decoration-break#how-does-this-even-work)
...
### [Complex selectors](https://tailwindcss.com/docs/box-decoration-break#complex-selectors)
...
<a href="#" class="group rounded-lg p-8">
  <!-- ... -->
  <span class="group-hover:underline">Read more…</span></a>
```
...
<div class="[&>[data-active]+span]:text-blue-600 ...">
  ...
  <span>This text will be blue</span></div>
```
...
### [When to use inline styles](https://tailwindcss.com/docs/box-decoration-break#when-to-use-inline-styles)
...
## [Managing duplication](https://tailwindcss.com/docs/box-decoration-break#managing-duplication)
...
![Contributors avatars](https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80)![Contributors avatars](https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80)![Contributors avatars](https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80)![Contributors avatars](https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80)![Contributors avatars](https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80)
...
### [Using loops](https://tailwindcss.com/docs/box-decoration-break#using-loops)
...
### [Using multi-cursor editing](https://tailwindcss.com/docs/box-decoration-break#using-multi-cursor-editing)
...
[Home](https://tailwindcss.com/docs/box-decoration-break#/dashboard)[Team](https://tailwindcss.com/docs/box-decoration-break#/team)[Projects](https://tailwindcss.com/docs/box-decoration-break#/projects)[Reports](https://tailwindcss.com/docs/box-decoration-break#/reports)

```html
<nav class="flex justify-center space-x-4">
  <a href="/dashboard" class="font-m rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900">
    Home
  </a>
  <a href="/team" class="font-m rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900">
    Team
  </a>
  <a href="/projects" class="font-m rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900">
    Projects
  </a>
  <a href="/reports" class="font-m rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900">
    Reports
  </a>
</nav>
```

### [Using components](https://tailwindcss.com/docs/box-decoration-break#using-components)
...
![Vacation card](https://images.unsplash.com/photo-1452784444945-3f422708fe5e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=512&q=80)

Private Villa

[Relaxing All-Inclusive Resort in Cancun](https://tailwindcss.com/docs/box-decoration-break#)
...
### [Using custom CSS](https://tailwindcss.com/docs/box-decoration-break#using-custom-css)
...
## [Managing style conflicts](https://tailwindcss.com/docs/box-decoration-break#managing-style-conflicts)

### [Conflicting utility classes](https://tailwindcss.com/docs/box-decoration-break#conflicting-utility-classes)
...
### [Using the important modifier](https://tailwindcss.com/docs/box-decoration-break#using-the-important-modifier)
...
### [Using the important flag](https://tailwindcss.com/docs/box-decoration-break#using-the-important-flag)
...
### [Using the prefix option](https://tailwindcss.com/docs/box-decoration-break#using-the-prefix-option)
